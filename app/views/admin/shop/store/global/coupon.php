	...
	<div class="spanLine">
        ...
        <div class="spanStage">
            ...
            <div class="spanLineRight">
                <p class="gray">本項目為每滿多少錢可以啟用折扣規則及會員可以使用之多少折扣金，留空則不啟用折扣金系統</p>
                <p class="gray">例如：每滿1000元才可使用折扣金100元</p>
            </div>
        </div>
	</div>
...
<div class="contentBox allWidth">
    ...
    <div class="spanLine">
        <div class="spanStage">
            ...
            <div class="spanLineLeft width500">
                單次購物訂單滿 <input type="text" name="shop_rule_coupon_count_Num" placeholder="贈送金額" style="width: 80px;" value="<?=$coupon_SettingList->obj_Arr['shop_rule_coupon_count']->value_Str?>"> 元，可以贈送 <input type="text" name="shop_rule_get_coupon_count_Num" placeholder="贈送金額" style="width: 80px;" value="<?=$coupon_SettingList->obj_Arr['shop_rule_get_coupon_count']->value_Str?>"> 元折扣金
            </div>
        </div>
        <div class="spanStage">
            <div class="spanLineLeft">
            ...
            <div class="spanLineRight">
                <p class="gray">本項目為訂單每滿多少金額可以贈送多少折扣金，留空則不啟用滿額贈送折扣金之規則</p>
                <p class="gray">例如：每滿1000元才可使用折扣金100元</p>
            </div>
        </div>
    </div>
