...
class showpiece_controller extends FS_controller {
    ...
    public function edit()
    {
        ...
        $data['showpiece_ShowpieceSolnine'] = new ShowpieceSolnine();
        $data['showpiece_ShowpieceSolnine']->construct_db(array(
            'db_where_Arr' => array(
    ...
    public function edit_post()
    {
        ...
        if ($this->form_validation->run() !== FALSE)
        {
            ...
            //建構ShowpieceSolnine物件，並且更新
            $showpiece_ShowpieceSolnine = new ShowpieceSolnine();
            $showpiece_ShowpieceSolnine->construct(array(
                'showpieceid_Num' => $showpieceid_Num,
                'name_Str' => $name_Str,
                'price_Num' => $price_Num,
            ...
            $showpiece_ShowpieceSolnine->update(array());
    ...
    public function tablelist()
    {
        ...
        $data['showpiece_ShowpieceSolnineList'] = new ObjList();
        $data['showpiece_ShowpieceSolnineList']->construct_db(array(
            'db_where_Arr' => array(
        ...
        $data['showpiece_links'] = $data['showpiece_ShowpieceSolnineList']->create_links(array('base_url_Str' => 'admin/'.$data['child1_name_Str'].'/'.$data['child2_name_Str'].'/'.$data['child3_name_Str'].'/'.$data['child4_name_Str']));
    ...
    public function delete()
    {
        ...
        {
            $showpiece_ShowpieceSolnine = new ShowpieceSolnine();
            $showpiece_ShowpieceSolnine->construct(array('showpieceid_Num' => $showpieceid_Num));
            $showpiece_ShowpieceSolnine->delete();
